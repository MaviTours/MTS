...
module.exports = "<p-growl [value]=\"msgs\"></p-growl>\r\n<p-blockUI #pnl [blocked]=\"blocked\">\r\n    <div class=\"ui-g\" style=\"position: absolute;top: 0;bottom: 0;left: 0;right: 0;margin: auto;width:100px;height: 100px;\">\r\n        <div class=\"ui-g-12 ui-md-12 ui-lg-12\">\r\n            <i class=\"fa fa-circle-o-notch fa-spin fa-5x\" style=\"color:white; margin: 0 auto;\"></i>\r\n        </div>\r\n        <div class=\"ui-g-12 ui-md-12 ui-lg-12\" style=\"color:white; margin: 0 auto;\">\r\n            <strong>Procesando</strong>\r\n        </div>\r\n    </div>\r\n</p-blockUI>\r\n<div class=\"ui-fluid\" #frm>\r\n    <div class=\"ui-g\" *ngIf=\"!esConductor\">\r\n        <div class=\"ui-g-12 ui-md-12 ui-lg-6\">\r\n            <p-panel header=\"{{'vehiculo.soat' | translate}}\">\r\n                <p-dataTable #dtSOAT [paginator]=\"true\" scrollable=\"true\" [responsive]=\"true\" emptyMessage=\"{{ 'generico.no.registro' | translate }}\"\r\n                    scrollWidth=\"100%\">\r\n                    <p-column header=\"{{ 'vehiculo.placa' | translate }}\" field=\"placa\"></p-column>\r\n                    <p-column header=\"{{ 'vehiculo.denominacion' | translate }}\" field=\"denominacion\"></p-column>\r\n                    <p-column header=\"{{ 'generico.vencimiento' | translate }}\" field=\"vencimiento\"></p-column>\r\n                    <p-column header=\"{{ 'proveedor.descripcion' | translate }}\" field=\"proveedor\"></p-column>\r\n                    <p-column header=\"{{ 'vehiculo.poliza' | translate }}\" field=\"poliza\"></p-column>\r\n                </p-dataTable>\r\n            </p-panel>\r\n        </div>\r\n        <div class=\"ui-g-12 ui-md-12 ui-lg-6\">\r\n            <p-panel header=\"{{'generico.traslados.diarios' | translate | uppercase}}\">\r\n                <p-dataTable #dtTraslados [paginator]=\"true\" scrollable=\"true\" [responsive]=\"true\" emptyMessage=\"{{ 'generico.no.registro' | translate }}\"\r\n                    scrollWidth=\"100%\">\r\n                    <p-column header=\"{{ 'traslado.titulo' | translate }}\" field=\"traslado\"></p-column>\r\n                    <p-column header=\"{{ 'traslado.partida' | translate }}\" field=\"partida\"></p-column>\r\n                    <p-column header=\"{{ 'generico.hora' | translate }}\" field=\"hora\"></p-column>\r\n                    <p-column header=\"{{ 'conductor.descripcion' | translate }}\" field=\"descripcion\"></p-column>\r\n                    <p-column header=\"{{ 'vehiculo.placa' | translate }}\" field=\"placa\"></p-column>\r\n                    <p-column header=\"{{ 'generico.estado' | translate }}\" field=\"estado\" styleClass=\"textoCentrado\"></p-column>\r\n                </p-dataTable>\r\n            </p-panel>\r\n        </div>\r\n    </div>\r\n    <div class=\"ui-g\" *ngIf=\"!esConductor\">\r\n        <div class=\"ui-g-12 ui-md-12 ui-lg-6\">\r\n            <p-panel header=\"{{'vehiculo.eirl' | translate}}\">\r\n                <p-dataTable #dtEIRL [paginator]=\"true\" scrollable=\"true\" [responsive]=\"true\" scrollHeight=\"200%\" emptyMessage=\"{{ 'generico.no.registro' | translate }}\"\r\n                    scrollWidth=\"100%\">\r\n                    <p-column header=\"{{ 'vehiculo.placa' | translate }}\" field=\"placa\"></p-column>\r\n                    <p-column header=\"{{ 'vehiculo.denominacion' | translate }}\" field=\"denominacion\"></p-column>\r\n                    <p-column header=\"{{ 'generico.vencimiento' | translate }}\" field=\"vencimiento\"></p-column>\r\n                    <p-column header=\"{{ 'proveedor.descripcion' | translate }}\" field=\"proveedor\"></p-column>\r\n                    <p-column header=\"{{ 'vehiculo.poliza' | translate }}\" field=\"poliza\"></p-column>\r\n                </p-dataTable>\r\n            </p-panel>\r\n        </div>\r\n    </div>\r\n\r\n    <p-schedule *ngIf=\"esConductor\" #horario [events]=\"traslados\" [header]=\"headerConfig\"></p-schedule>\r\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__usuarioactual__ = __webpack_require__("../../../../../src/app/home/usuarioactual.ts");
...
var BienvenidaComponent = (function (_super) {
    ...
    function BienvenidaComponent() {
        ...
        _this.fechaInicio2 = new Date();
        _this.usuarioActual = new __WEBPACK_IMPORTED_MODULE_2__usuarioactual__["a" /* UsuarioActual */]();
        _this.fotografiaUsuario = "";
    ...
    BienvenidaComponent.prototype.ngOnInit = function () {
        console.log("BienvenidaComponent => " + this.blocked);
        ...
        this.traslados = [
            {
                "title": "Ir a Av Universitaria 474, S. Miguel",
                "start": "2017-10-30T07:00:00",
                "end": "2017-10-30T08:00:00"
            },
            {
                "title": "Ir a Av San Luis 839, S. Surco",
                "start": "2017-10-30T10:00:00",
                "end": "2017-10-30T11:00:00"
            },
            {
                "title": "Ir a Av San Juan 474, SJM",
                "start": "2017-10-30T12:00:00",
                "end": "2017-10-30T14:00:00"
            },
            {
                "title": "Ir a Av. Benavides 234, Mir.",
                "start": "2017-10-31T16:00:00",
                "end": "2017-10-31T16:40:00"
            },
            {
                "title": "Ir a Av. Parto 123, Mir",
                "start": "2017-11-01T16:00:00",
                "end": "2017-11-01T17:00:00"
            }
        ];
        /*this.preCarga();
        this.verAniversarios();
        this.verCumpleanios();*/
    };
    BienvenidaComponent.prototype.preCarga = function () {
        this.usuarioActual = new __WEBPACK_IMPORTED_MODULE_2__usuarioactual__["a" /* UsuarioActual */]();
    };
    BienvenidaComponent.prototype.buscar = function () {
    };
    BienvenidaComponent.prototype.verCumpleanios = function () {
        this.bloquearPagina();
        if (this.fechaInicio == null) {
            this.fechaInicio = new Date();
        }
    };
    BienvenidaComponent.prototype.verAniversarios = function () {
        this.bloquearPagina();
        if (this.fechaInicio2 == null) {
            this.fechaInicio2 = new Date();
        }
    };
...
var RecursoSelectorComponent = (function (_super) {
    ...
    RecursoSelectorComponent.prototype.buscarConductores = function () {
        var _this = this;
        console.log(this.filtroConductor);
...
var RecursoTrasladoMantenimientoComponent = (function (_super) {
    ...
    function RecursoTrasladoMantenimientoComponent() {
        var _this = _super.call(this) || this;
        _this.verModal = false;
        _this.traslado = new __WEBPACK_IMPORTED_MODULE_2__traslado_traslado__["a" /* Traslado */]();
        _this.accionNombre = '';
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_0__recurso_selector_component__["a" /* RecursoSelectorComponent */]),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cliente_mantenimiento_component__ = __webpack_require__("../../../../../src/app/mavitours/cliente/cliente-mantenimiento.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cliente_service__ = __webpack_require__("../../../../../src/app/mavitours/cliente/cliente.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
var ClienteListadoComponent = (function (_super) {
    ...
    function ClienteListadoComponent(clienteService) {
        var _this = _super.call(this) || this;
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_0__cliente_mantenimiento_component__["a" /* ClienteMantenimientoComponent */]),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__cliente_mantenimiento_component__["a" /* ClienteMantenimientoComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__cliente_mantenimiento_component__["a" /* ClienteMantenimientoComponent */]) === "function" && _a || Object)
...
ClienteListadoComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__cliente_service__["a" /* ClienteService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__cliente_service__["a" /* ClienteService */]) === "function" && _b || Object])
...
module.exports = "<p-growl [value]=\"msgs\" [life]=\"6000\"></p-growl>\r\n<p-blockUI #pnl [blocked]=\"blocked\">\r\n    <div class=\"ui-g\" style=\"position: absolute;top: 0;bottom: 0;left: 0;right: 0;margin: auto;width:100px;height: 100px;\">\r\n        <div class=\"ui-g-12 ui-md-12 ui-lg-12\">\r\n            <i class=\"fa fa-circle-o-notch fa-spin fa-5x\" style=\"color:white; margin: 0 auto;\"></i>\r\n        </div>\r\n        <div class=\"ui-g-12 ui-md-12 ui-lg-12\" style=\"color:white; margin: 0 auto;\">\r\n            <strong>Procesando</strong>\r\n        </div>\r\n    </div>\r\n</p-blockUI>\r\n<div class=\"ui-fluid\" #frm>\r\n    <p-panel header=\"{{'conductor.titulo' | translate | uppercase}} : {{'generico.filtros' | translate }}\">\r\n        <div class=\"ui-g ui-md ui-lg\">\r\n            <div class=\"ui-g-12 ui-md-2 ui-lg-1 controlEtiquetaDivTop\">\r\n                <label translate>generico.codigo</label>\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-4 ui-lg-1\">\r\n                <input pInputText type=\"text\" style=\"width:100%\" />\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-2 ui-lg-1 controlEtiquetaDivTop\">\r\n                <label translate>conductor.nombre</label>\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-4 ui-lg-3\">\r\n                <input pInputText type=\"text\" style=\"width:100%\" />\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-2 ui-lg-1 controlEtiquetaDivTop\">\r\n                <label translate>conductor.brevete</label>\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-4 ui-lg-2\">\r\n                <input pInputText type=\"text\" style=\"width:100%\" />\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-2 ui-lg-1 controlEtiquetaDivTop\">\r\n                <label translate>conductor.categoria</label>\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-4 ui-lg-2\">\r\n                <p-dropdown [style]=\"{'width':'100%'}\"></p-dropdown>\r\n            </div>\r\n        </div>\r\n\r\n    </p-panel>\r\n\r\n\r\n    <div class=\"ui-g ui-md ui-lg\">\r\n        <div class=\"ui-g-5 ui-md-2 ui-lg-1\">\r\n            <button pButton label=\"{{'btn.nuevo' | translate}}\" icon=\"fa fa-plus\" class=\"ui-button\" type=\"button\" title=\"{{'btn.nuevo' | translate}}\"\r\n                (click)=\"nuevo(dtConductores)\"></button>\r\n        </div>\r\n        <div class=\"ui-g-2 ui-md-8 ui-lg-10\"></div>\r\n        <div class=\"ui-g-5 ui-md-2 ui-lg-1\">\r\n            <button pButton label=\"{{'btn.buscar' | translate}}\" icon=\"fa fa-binoculars\" class=\"ui-button\" type=\"button\" title=\"{{'btn.buscar' | translate}}\"></button>\r\n        </div>\r\n    </div>\r\n\r\n    <p-dataTable #dtConductores [paginator]=\"true\" [responsive]=\"true\" scrollWidth=\"100%\" scrollable=\"true\" [rows]=\"7\" emptyMessage=\"{{ 'generico.no.registro' | translate }}\">\r\n        <p-column header=\"{{'generico.codigo' |  translate}}\" field=\"id\"></p-column>\r\n        <p-column header=\"{{'conductor.nombre' |  translate}} \" field=\"nombre\"></p-column>\r\n        <p-column header=\"{{'conductor.brevete' |  translate}} \" field=\"brevete\"></p-column>\r\n        <p-column header=\"{{'generico.vencimiento' |  translate}} \" field=\"vencimiento\"></p-column>\r\n        <p-column header=\"{{'conductor.categoria' |  translate}}\" field=\"categoria\"></p-column>\r\n        <p-column header=\"{{'conductor.direccion' |  translate}}\" field=\"direccion\"></p-column>\r\n        <p-column header=\"{{'generico.telefono' |  translate}}\" field=\"telefono\"></p-column>\r\n        <p-column header=\"{{'generico.correo' |  translate}}\" field=\"correo\"></p-column>\r\n        <p-column header=\"{{'generico.accion' | translate}}\" styleClass=\"textoCentrado\">\r\n            <ng-template let-tx=\"rowData\" pTemplate=\"body\">\r\n                <div class=\"ui-g\">\r\n                    <div class=\"ui-g-6 ui-md-6 ui-lg-6\" title=\"{{'btn.editar' | translate}}\">\r\n                        <i class=\"fa fa-pencil fa-lg seleccionable\"></i>\r\n                    </div>\r\n                </div>\r\n            </ng-template>\r\n        </p-column>\r\n    </p-dataTable>\r\n    <conductor-mantenimiento (enviarMensaje)=\"mostrarMensajes($event)\" (enviarListar)=\"listar()\" (enviarMostrarDialog)=\"mostrarDialogPre($event)\"></conductor-mantenimiento>\r\n    <p-confirmDialog #cd>\r\n        <p-footer>\r\n            <button type=\"button\" pButton icon=\"fa-check\" label=\"Ok\" (click)=\"cd.accept()\"></button>\r\n        </p-footer>\r\n    </p-confirmDialog>"
...
var ConductorListadoComponent = (function (_super) {
    ...
    function ConductorListadoComponent(conductorService, confirmationService) {
        var _this = _super.call(this) || this;
        _this.conductorService = conductorService;
...
var ProveedorSaludListadoComponent = (function (_super) {
    ...
    ProveedorSaludListadoComponent.prototype.cargarProveedores = function (event) {
        ...
        this.bloquearPagina();
        this.paginacion.registroInicio = event.first;
        this.paginacion.cantidadRegistrosDevolver = this.rows;
        this.paginacion.listaResultado = [];
        this.proveedorSaludService.listarTodos(this.paginacion).then(function (res) {
            _this.desbloquearPagina();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__asignacion_recurso_traslado_component__ = __webpack_require__("../../../../../src/app/mavitours/asignacion/recurso-traslado.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__traslado_service__ = __webpack_require__("../../../../../src/app/mavitours/traslado/traslado.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plan_plan_service__ = __webpack_require__("../../../../../src/app/mavitours/plan/plan.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__traslado__ = __webpack_require__("../../../../../src/app/mavitours/traslado/traslado.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__plan_plan__ = __webpack_require__("../../../../../src/app/mavitours/plan/plan.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__home_parametropaginacion__ = __webpack_require__("../../../../../src/app/home/parametropaginacion.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__comun_basecomponent__ = __webpack_require__("../../../../../src/app/comun/basecomponent.ts");
...
var TrasladoListadoComponent = (function (_super) {
    ...
    function TrasladoListadoComponent(trasladoService, router, activatedRoute, planService) {
        ...
        _this.filtro = new __WEBPACK_IMPORTED_MODULE_4__traslado__["a" /* Traslado */]();
        _this.paginacion = new __WEBPACK_IMPORTED_MODULE_6__home_parametropaginacion__["a" /* ParametroPaginacion */]();
        _this.lstPlanes = [];
        return _this;
    }
    TrasladoListadoComponent.prototype.ngOnInit = function () {
        ...
        var filtro = new __WEBPACK_IMPORTED_MODULE_5__plan_plan__["a" /* Plan */]();
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_0__asignacion_recurso_traslado_component__["a" /* RecursoTrasladoComponent */]),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__asignacion_recurso_traslado_component__["a" /* RecursoTrasladoComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__asignacion_recurso_traslado_component__["a" /* RecursoTrasladoComponent */]) === "function" && _a || Object)
...
TrasladoListadoComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__traslado_service__["a" /* TrasladoService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__traslado_service__["a" /* TrasladoService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["Router"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["Router"]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["ActivatedRoute"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["ActivatedRoute"]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__plan_plan_service__["a" /* PlanService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__plan_plan_service__["a" /* PlanService */]) === "function" && _e || Object])
...
var TrasladoService = (function () {
    function TrasladoService(http) {
        this.http = http;
        this.url = __WEBPACK_IMPORTED_MODULE_2__constantes__["a" /* REST_URL */] + '/api/traslados/';
        this.headers = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["b" /* Headers */]({ 'Content-Type': 'application/json' });
    }
...
module.exports = "<p-growl [value]=\"msgs\"></p-growl>\r\n<p-blockUI #pnl [blocked]=\"blocked\">\r\n    <div class=\"ui-g\" style=\"position: absolute;top: 0;bottom: 0;left: 0;right: 0;margin: auto;width:100px;height: 100px;\">\r\n        <div class=\"ui-g-12 ui-md-12 ui-lg-12\">\r\n            <i class=\"fa fa-circle-o-notch fa-spin fa-5x\" style=\"color:white; margin: 0 auto;\"></i>\r\n        </div>\r\n        <div class=\"ui-g-12 ui-md-12 ui-lg-12\" style=\"color:white; margin: 0 auto;\">\r\n            <strong>Procesando</strong>\r\n        </div>\r\n    </div>\r\n</p-blockUI>\r\n<div class=\"ui-fluid\" #frm>\r\n    <p-panel header=\"{{'vehiculo.titulo' | translate | uppercase}} : {{'generico.filtros' | translate }}\">\r\n        <div class=\"ui-g ui-md ui-lg\">\r\n            <div class=\"ui-g-12 ui-md-2 ui-lg-1 controlEtiquetaDivTop\">\r\n                <label translate>vehiculo.placa</label>\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-4 ui-lg-1\">\r\n                <input pInputText type=\"text\" style=\"width:100%\" />\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-2 ui-lg-1 controlEtiquetaDivTop\">\r\n                <label translate>vehiculo.denominacion</label>\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-4 ui-lg-3\">\r\n                <input pInputText type=\"text\" style=\"width:100%\" />\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-2 ui-lg-1 controlEtiquetaDivTop\">\r\n                <label translate>vehiculo.marca</label>\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-4 ui-lg-1\">\r\n                <p-dropdown [style]=\"{'width':'100%'}\"></p-dropdown>\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-2 ui-lg-1 controlEtiquetaDivTop\">\r\n                <label translate>vehiculo.capacidad</label>\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-4 ui-lg-1\">\r\n                <p-spinner size=\"30\"></p-spinner>\r\n            </div>\r\n            <div class=\"ui-g-12 ui-md-2 ui-lg-1 controlEtiquetaDivTop\">\r\n                <label translate>generico.estado</label>\r\n            </div>\r\n\r\n            <div class=\"ui-g-12 ui-md-4 ui-lg-1\">\r\n                <p-dropdown [style]=\"{'width':'100%'}\" [options]=\"lstEstadoListado\"></p-dropdown>\r\n            </div>\r\n        </div>\r\n    </p-panel>\r\n\r\n    <div class=\"ui-g ui-md ui-lg\">\r\n        <div class=\"ui-g-5 ui-md-2 ui-lg-1\">\r\n            <button pButton label=\"{{'btn.nuevo' | translate}}\" icon=\"fa fa-plus\" class=\"ui-button\" type=\"button\" title=\"{{'btn.nuevo' | translate}}\"\r\n                (click)=\"nuevo()\"></button>\r\n        </div>\r\n        <div class=\"ui-g-2 ui-md-8 ui-lg-10\"></div>\r\n        <div class=\"ui-g-5 ui-md-2 ui-lg-1\">\r\n            <button pButton label=\"{{'btn.buscar' | translate}}\" icon=\"fa fa-binoculars\" class=\"ui-button\" type=\"button\" title=\"{{'btn.buscar' | translate}}\"></button>\r\n        </div>\r\n    </div>\r\n\r\n    <p-dataTable #dtVechiculos [paginator]=\"true\" [responsive]=\"true\" scrollWidth=\"100%\" scrollable=\"true\" [rows]=\"7\" emptyMessage=\"{{ 'generico.no.registro' | translate }}\">\r\n        <p-column header=\"{{'generico.id' | translate}}\" field=\"id\"></p-column>\r\n        <p-column header=\"{{'vehiculo.placa' | translate}}\" field=\"placa\"></p-column>\r\n        <p-column header=\"{{'vehiculo.denominacion' | translate}}\" field=\"denominacion\"></p-column>\r\n        <p-column header=\"{{'generico.empresa' | translate}}\" field=\"empresa\"></p-column>\r\n        <p-column header=\"{{'vehiculo.categoria' | translate}}\" field=\"categoria\"></p-column>\r\n        <p-column header=\"{{'vehiculo.chasis' | translate}}\" field=\"chasis\"></p-column>\r\n        <p-column header=\"{{'vehiculo.motor' | translate}}\" field=\"motor\"></p-column>\r\n        <p-column header=\"{{'vehiculo.capacidad' | translate}}\" field=\"asientos\"></p-column>\r\n    </p-dataTable>\r\n    <vehiculo-mantenimiento (enviarMensaje)=\"mostrarMensajes($event)\" (enviarListar)=\"listar()\"></vehiculo-mantenimiento>"
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vehiculo_mantenimiento_component__ = __webpack_require__("../../../../../src/app/mavitours/vehiculo/vehiculo-mantenimiento.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vehiculo_service__ = __webpack_require__("../../../../../src/app/mavitours/vehiculo/vehiculo-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__comun_basecomponent__ = __webpack_require__("../../../../../src/app/comun/basecomponent.ts");
...
var VehiculoListadoComponent = (function (_super) {
    ...
    function VehiculoListadoComponent(vehiculoService) {
        var _this = _super.call(this) || this;
        _this.vehiculoService = vehiculoService;
        return _this;
    }
    ...
    VehiculoListadoComponent.prototype.buscar = function () {
    };
    VehiculoListadoComponent.prototype.nuevo = function () {
        this.vechiculoMantenimientoComponent.nuevo();
    };
    return VehiculoListadoComponent;
}(__WEBPACK_IMPORTED_MODULE_3__comun_basecomponent__["a" /* BaseComponent */]));
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_0__vehiculo_mantenimiento_component__["a" /* VechiculoMantenimientoComponent */]),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__vehiculo_mantenimiento_component__["a" /* VechiculoMantenimientoComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__vehiculo_mantenimiento_component__["a" /* VechiculoMantenimientoComponent */]) === "function" && _a || Object)
...
VehiculoListadoComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__vehiculo_service__["a" /* VehiculoService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__vehiculo_service__["a" /* VehiculoService */]) === "function" && _b || Object])
